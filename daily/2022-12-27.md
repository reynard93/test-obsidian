...
nvim /opt/homebrew/opt/fzf/shell/key-bindings.zsh
i see this file that has config for keybindings for fzf with alt-c cmd defined but cant get it to work on my machine
